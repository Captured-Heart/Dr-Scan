...
class FileLeftSelectionPageScreen extends StatefulWidget {
  final nameController = Get.arguments;

  @override
  State<FileLeftSelectionPageScreen> createState() =>
      _FileLeftSelectionPageScreenState();
}

class _FileLeftSelectionPageScreenState
    extends State<FileLeftSelectionPageScreen> {
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding: EdgeInsets.only(top: getVerticalSize(38.00)),
                    child: Row(
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: SvgPicture.asset(
                                  ImageConstant.imgCirclebutton3,
                                  fit: BoxFit.fill),
                            ),
                          ),
                        ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                  ...
                                  child: Text("lbl_load_you_file".tr,
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.center,
                                      style: AppStyle
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: AppStyle.textstylemontserratextrabold20
                                .copyWith(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: AppStyle.textstylemontserratextrabold20
                                .copyWith(
                                    fontSize: getFontSize(20), height: 1.40),
                          ),
                        ),
                      ),
                    ),
                  ...
                  Container(
                    margin: EdgeInsets.only(top: getVerticalSize(143.00)),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                  padding: EdgeInsets.only(
                                      left: getHorizontalSize(11.32),
                                      right: getHorizontalSize(11.32)),
                                  child: Container(
                                      height: getVerticalSize(30.00),
                                      width: getHorizontalSize(33.96),
                                      child: SvgPicture.asset(
                                          ImageConstant.imgSoliddevicesc4,
                                          fit: BoxFit.fill))),
                              Padding(
                                  padding: EdgeInsets.only(
                                      left: getHorizontalSize(9.92),
                                      right: getHorizontalSize(11.32),
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: Container(
                                        ...
                                        width: getHorizontalSize(33.96),
                                        child: SvgPicture.asset(
                                            ImageConstant.imgSolidfilesima4,
                                            fit: BoxFit.fill))),
                                Padding(
                                    padding: EdgeInsets.only(
                                        left: getHorizontalSize(1.87),
                                        right: getHorizontalSize(1.21),
                                        bottom: getVerticalSize(2.00)),
  ...
  onTapBtnCaptureimage() {
    Get.toNamed(AppRoutes.analyzingRightPageScreen,
        arguments: [imgFile, widget.nameController, 'Left']);
  }
